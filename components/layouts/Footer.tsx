...
export default function Footer() {
  return (
    <footer class={tw`bg-pallete-secondary-4 text-pallete-primary p-3 md:flex md:justify-around md:flex-wrap`}>
      ...
      <div class="flex md:w-1/2 justify-between my-3 md:gap-3 lg:gap-6 xl:gap-9">
      ...
      <div class="flex md:w-full justify-center text-sm items-center gap-2 my-3">
        <h4>
          All rights reserved
        </h4>
        <FaCopyright />
